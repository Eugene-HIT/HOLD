...
new_anny = '''                            val extractedSteps = try {
                            ...
                            if (existingAnny != null) {
                                ...
                                poolItems.add(0, HelpRequest("Anny", "想要${userTask}，状态是${userState}", System.currentTimeMillis(), extractedSteps))
                                if (poolItems.size > 10) poolItems.removeAt(poolItems.size - 1)
                            }'''
...
if 'setupDetailTasks(taskDesc: String, steps: List<String>)' not in text:
