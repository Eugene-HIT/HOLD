 ...
 * - loop(): 轮询 FIFO，更新原始 PPG 与轻处理显示量，持续输出胸口模式 13 通道 VOFA 数据。
 * 最后更改时间: 2026-07-05
 * 累加式更改日志:
 ...
 * - 2026-07-01: 将胸口 VOFA 入口的 MAX30102 接线切回整机一致的主 I2C D4/D5，便于在完整设备接线下直接测试。
 * - 2026-07-05: 追加上一拍到本拍的心跳间隔 `lastBeatIntervalMs` 输出，便于直接观察 beat-to-beat 时间。
 * 注意事项:
